        ...
        `
          ...
          <a href="title.html?id=${music.id}">
             ...
             <h3 id="titrealbum">${music.album.title}</h3>
              ...
              <button onclick="window.location.href = 'title.html?id=${music.id}';"class="button2"> Écouter un extrait </button>
              <button onclick="window.location.href = 'album.html?id=${music.album.id}';" class="button2"> Consulter l'album </button>
              <button onclick="window.location.href = 'artiste.html?id=${music.artist.id}';" class="button2"> Voir la fiche de l'artiste</button>
