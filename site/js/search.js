...
const result = document.getElementById("result"); // on cible dans la page HTML la div #result
...
// Tu vas chercher dans l'API tous les résultats de Deezer
async function VaChercherDanslAPI() {
  await fetch("https://api.deezer.com/search?q=carimi")
...
// titrealbum.textContent = result.data[0].album.title;
// artiste.textContent = result.data[0].artist.name;
// titremusique.textContent = result.data[0].title_short;
// duree.textContent = result.data[0].duration;

function Results() {
  resultats.length = 25;
  result.innerHTML += resultats.map(
    (music) => `
        <article>
            <picture>
                <img id="img_article" src="${music.album.cover_big}" alt="">
            </picture>
...
// VaChercherDanslAPI();
// Results();
// `<h4 id="h2-resultat"> Résultats de la recherche </h4>
// <div class="wrap-article">
//     <article>
//         <picture>
//             <img id="img_article" src="" alt="">
//         </picture>
//         <h3 id="titrealbum">${resultats.album.title}</h3>
//         <p id="artiste"> </p>
//         <p id="titremusique"> </p>
//         <p id="duree"> </p>
//         <button class="button3">
