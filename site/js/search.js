      ...
      (music) =>
        `
          ...
          <a href="title.html?id=${music.id}">
              <div id="img_article" style="background-image: url(${
             ...
             <h3 id="titrealbum">${music.album.title}</h3>
              ...
              <p id="duree">${convertTime(music.duration)}</p>
              <button class="button3">
                <svg width="18px" viewBox="0 -28 512.001 512" xmlns="http://www.w3.org/2000/svg">
              ...
              <button onclick="window.location.href = 'title.html?id=${
                music.id
              }';"class="button2"> Écouter un extrait </button>
              <button onclick="window.location.href = 'album.html?id=${
                music.album.id
              }';" class="button2"> Consulter l'album </button>
              <button onclick="window.location.href = 'artiste.html?id=${
                music.artist.id
              }';" class="button2"> Voir la fiche de l'artiste</button>
